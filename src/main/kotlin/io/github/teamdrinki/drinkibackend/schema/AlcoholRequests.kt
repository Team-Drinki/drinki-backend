 ...
 */
object AlcoholRequests : IntIdTable("AlcoholRequests") {
    val tastingNote = reference("tasting_note_id", TastingNotes.id)
    ...
    val category = reference("category_id", AlcoholCategories.id)
    val styleId = reference("style_id", AlcoholStyles.id)
    val location = reference("location_id", AlcoholLocations.id)
