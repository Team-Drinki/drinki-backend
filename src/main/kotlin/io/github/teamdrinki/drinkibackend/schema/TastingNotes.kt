...
object TastingNotes : LongIdTable("TastingNotes") {
    ...
    val aromaNote = jsonb<Map<String, Map<String, Double>>>("aroma_note", format)
    val palateNote = jsonb<Map<String, Map<String, Double>>>("palate_note", format)
    val finishNote = jsonb<Map<String, Map<String, Double>>>("finish_note", format)
