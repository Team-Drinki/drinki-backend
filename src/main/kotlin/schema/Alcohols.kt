...
object Alcohols : Table("Alcohols") {
    ...
    val image = blob("image")  // Exposed does not have native image, blob is alternative
    ...
    val location = enumerationByName("location", 255, LocationEnum::class)
    val description = varchar("description", 1000)
    val like = integer("like")
    val unlike = integer("unlike")
